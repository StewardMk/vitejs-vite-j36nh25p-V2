...
const INTRO_COPY: Record<string, string> = {
  ...
  pretest_intro:
    "## OET General Knowledge Pre-test\n\nThis is a diagnostic test, not a pass/fail examination. It checks your current understanding of the OET and highlights areas that need training \u2014 it does not measure your actual Listening, Reading, Writing or Speaking ability.\n\n- **Test time:** 25 minutes\n- **Total questions:** 30\n- **Scored questions:** 25 (Questions 1\u201325)\n- **Maximum score:** 25 marks\n\n## Instructions\n\n- Answer all questions honestly.\n- Choose the best answer unless a question asks you to select all appropriate options.\n- Do not use Google, notes, OET preparation materials, or help from another person.\n- Read each question carefully \u2014 some test practical understanding, not simple recall.\n- Suggested pacing: 15 minutes for Questions 1\u201325, 10 minutes for Questions 26\u201330.\n\n## Section F\n\nQuestions 26\u201330 are about your own preparation and are **not scored** \u2014 answer them as they apply to you.\n\nClick 'Next' button to begin.",
}
